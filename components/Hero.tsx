...
const Hero: React.FC = () => {
  const images = [
    "/imagens/inicio/retrato-de-frente.webp",
    "/imagens/inicio/examinando-paciente.webp",
    "/imagens/inicio/mostrando-exame-na-tela.webp"
  ];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 lg:flex-[1.1] text-center lg:text-left">
            <div className="inline-block bg-blue-50 text-blue-700 px-4 py-1.5 rounded-full text-sm font-semibold mb-6">
              <i className="fa-solid fa-award mr-2"></i> Ortopedista World-Class em Indaiatuba
            </div>
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-slate-900 leading-[1.1] mb-6">
              Recupere sua <span className="text-blue-700">liberdade</span> de movimento.
            </h1>
            ...
            <div className="flex flex-wrap justify-center lg:justify-start items-center gap-8 md:gap-12 grayscale opacity-70">
              ...
              <div className="h-10 w-px bg-slate-200 hidden sm:block"></div>
              <div className="flex flex-col">
                <span className="text-2xl md:text-3xl font-bold text-slate-800">UERJ + INTO</span>
