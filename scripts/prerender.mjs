...
const injectSeoModuleUrl = pathToFileURL(join(__dirname, 'prerender-seo-meta.ts')).href;
    ...
    try {
      for (const routePath of paths) {
        ...
        try {
          ...
          const { injectPrerenderSeoIntoHtml } = await import(injectSeoModuleUrl);
          const html = injectPrerenderSeoIntoHtml(raw, routePath);
