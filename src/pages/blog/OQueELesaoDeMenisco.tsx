...
const OQueELesaoDeMenisco: React.FC = () => (
  <BlogPostLayout
    ...
    heroImage="/imagens/inicio/examinando-paciente.webp"
    heroAlt="Dr. Raphael Serra Cruz examinando joelho do paciente em Indaiatuba"
    postId="o-que-e-lesao-de-menisco"
  >
...
export default OQueELesaoDeMenisco;
