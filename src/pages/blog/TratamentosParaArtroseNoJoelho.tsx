...
const TratamentosParaArtroseNoJoelho: React.FC = () => (
  <BlogPostLayout
    ...
    heroImage="/imagens/inicio/mostrando-exame-na-tela.webp"
    heroAlt="Dr. Raphael Serra Cruz, Ortopedista e Especialista em joelho em Indaiatuba, analisando exames"
    postId="tratamentos-para-artrose-no-joelho"
  >
...
export default TratamentosParaArtroseNoJoelho;
