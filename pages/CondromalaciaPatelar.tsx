  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="pt-20 flex-grow bg-slate-50">
        <section
          style={{ backgroundImage: 'url(/imagens/inicio/cards/condromalacia-dr-raphael-serra-cruz-full.webp)' }}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="lg:col-span-1">
                <aside className="bg-white rounded-xl shadow-sm border border-slate-100 sticky top-28 p-6">
                  <div className="mb-6">
                    <h3 className="text-sm font-bold uppercase tracking-wider text-slate-500 mb-3">Condromalácia e Instabilidade Patelar</h3>
                    <ul className="space-y-2 text-sm text-slate-600">
                      <li><a href="#biomecanica" className="hover:text-blue-600 transition">Condromalácia patelar e a importância da Biomecânica</a></li>
                      <li><a href="#o-que-e-condromalacia" className="hover:text-blue-600 transition">Mas afinal, o que é condromalácia patelar?</a></li>
                      <li><a href="#como-diagnosticar" className="hover:text-blue-600 transition">Como diagnosticar?</a></li>
                    </ul>
                  </div>
                  <div>
                    <h3 className="text-sm font-bold uppercase tracking-wider text-slate-500 mb-3">Tratamento</h3>
                    <ul className="space-y-2 text-sm text-slate-600">
                      <li><a href="#tratamento-conservador" className="hover:text-blue-600 transition">Tratamento conservador</a></li>
                      <li><a href="#quando-cirurgia" className="hover:text-blue-600 transition">Quando a cirurgia é considerada</a></li>
                    </ul>
                  </div>
                </aside>
              </div>
